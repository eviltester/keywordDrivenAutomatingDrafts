...
public class CanExecuteKeywordsTest {
    ...
    public void canExecuteKeywords(){
        ...
        keywordScriptList.add("click \t alertexamples"); // id // TODO handle finding an input by text ie. input[value='Show alert box']
        keywordScriptList.add("ok alert");
        keywordScriptList.add("click \t Show confirm box");
        ...
        //todo: can see text \t Hello, this is my input.
