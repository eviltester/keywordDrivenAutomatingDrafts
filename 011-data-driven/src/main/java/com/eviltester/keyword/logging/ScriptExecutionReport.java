...
public class ScriptExecutionReport {
    ...
    public String toString() {
        ...
        for(KeywordScriptExecutionEventReport embeddedScriptReport : reportDetails.getEmbeddedScriptReports()){
            reportOutput.append(new ScriptExecutionReport(embeddedScriptReport).toString());
        }

        if(reportDetails.hasScript()) {
